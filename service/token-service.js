...
class TokenService {
  ...
  generateTokens(payload) {
    const accessToken = jw.sign(payload, process.env.JWT_ACCESS_SECRET, { expiresIn: '15s' });
    const refreshToken = jw.sign(payload, process.env.JWT_REFRESH_SECRET, { expiresIn: '35s' });
